...
v4 exposes an exact set for every adaptive-policy option, removes the remaining
character-specific move seeds, and uses generated chord/motion hypotheses
throughout. A hard priority or
...
neutral/advantage movement, generic motion probes, and context-valid autonomous
